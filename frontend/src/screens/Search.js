    ...
    return (
        <div className="container__full">
            <div className="container__long">
                <div className="row margin__left__small">
                    <h5 className="content__text  margin__vertical__small">You searched <span style={{fontStyle: 'italic', fontWeight: '600'}}>"{search}"</span></h5>
                </div>
